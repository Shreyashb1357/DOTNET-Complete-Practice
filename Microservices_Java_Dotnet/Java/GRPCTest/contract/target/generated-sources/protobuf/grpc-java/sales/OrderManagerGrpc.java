...
public final class OrderManagerGrpc {
   ...
   */
  public static OrderManagerBlockingV2Stub newBlockingV2Stub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<OrderManagerBlockingV2Stub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<OrderManagerBlockingV2Stub>() {
        @java.lang.Override
        public OrderManagerBlockingV2Stub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
          return new OrderManagerBlockingV2Stub(channel, callOptions);
        }
      };
    return OrderManagerBlockingV2Stub.newStub(factory, channel);
  }
   ...
   */
  public static final class OrderManagerBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<OrderManagerBlockingV2Stub> {
    private OrderManagerBlockingV2Stub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected OrderManagerBlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new OrderManagerBlockingV2Stub(channel, callOptions);
    }
    ...
    /**
     */
    public sales.OrderManagerOuterClass.OrderStatus placeOrder(sales.OrderManagerOuterClass.OrderInput request) throws io.grpc.StatusException {
    ...
    public io.grpc.stub.BlockingClientCall<?, sales.OrderManagerOuterClass.CustomerOrder>
        fetchOrders(sales.OrderManagerOuterClass.CustomerInput request) {
  ...
  /**
   * A stub to allow clients to do limited synchronous rpc calls to service OrderManager.
   */
